...
GLuint loadTextureFromFileToGPU(const std::string &filename)
{
  ...
  GLuint texID;
  glGenTextures(1, &texID); //number of texture, where to store i t
  glBindTexture(GL_TEXTURE_2D, texID); //gli diciamo se chi
  //magnificagtion e minification
...
struct Scene {
  ...
  void render()
  {
    ...
    mainShader->set("material.isBackwall", 1); 
    ...
    mainShader->set("material.isBackwall", 0);
